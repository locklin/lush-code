...
extern TLAPI TLclass window_class;
TLAPI struct window *current_window(void);
...
TLAPI void enqueue_event(at*, int, int, int, int, int);
TLAPI void enqueue_eventdesc(at*, int, int, int, int, int, char*);
TLAPI void process_pending_events(void);
