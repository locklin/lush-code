...
/***********************************************************************
  ...
  $Id: allocate.c,v 1.1.1.1 2002-04-16 17:37:38 leonb Exp $
********************************************************************** */
...
ptr
tl_realloc (ptr address, size_t size)
{
  ptr value = realloc (address, size);
...
/*
 * garbage If called in 'STARTLISP' function, - unwinds symbol stacked values
