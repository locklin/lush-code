...
*/
void check_main_maout(struct idx *i1, struct idx *i2)
{
    Mcheck_main_maout(i1, i2);
}

void check_main_main_maout(struct idx *i0, struct idx *i1, struct idx *i2)
{
    Mcheck_main_main_maout(i0, i1, i2);
}

/* check if 1st arg is dimensioned (ma), and second is m0 */
void check_main_m0out(struct idx *i1, struct idx *i2)
{
    Mcheck_main_m0out(i1, i2);
}

/* check if 1st and 2nd arg have same global size (ma), and second is m0 */
void check_main_main_m0out(struct idx *i0, struct idx *i1, struct idx *i2)
{
...
*/
void check_main_m0in_maout(struct idx *i0, struct idx *i1, struct idx *i2)
{
    Mcheck_main_m0in_maout(i0, i1, i2);
}

void check_main_main_maout_dot21(struct idx *i0, struct idx *i1, struct idx *i2)
{
    Mcheck_main_main_maout_dot21(i0, i1, i2);
}

void check_main_main_maout_dot42(struct idx *i0, struct idx *i1, struct idx *i2)
{
    Mcheck_main_main_maout_dot42(i0, i1, i2);
}

void check_m1in_m1in_m2out(struct idx *i0, struct idx *i1, struct idx *i2)
{
    Mcheck_m1in_m1in_m2out(i0, i1, i2);
}

void check_m2in_m2in_m4out(struct idx *i0, struct idx *i1, struct idx *i2)
{
...
void Csame_size(struct idx *i1, struct idx *i2)
{ 
...
void size_or_check(struct idx *i1, struct idx *i2)
{ 
    is_sized(i1);
